...
extension AppTextTheme on BuildContext {
  ...
  TextStyle get primaryText => textTheme.bodyLarge!.copyWith(
        color: Theme.of(this).primaryColor,
      );
  
  TextStyle get errorText => textTheme.bodyMedium!.copyWith(
        color: Colors.red,
      );
  
  TextStyle get successText => textTheme.bodyMedium!.copyWith(
        color: Colors.green,
      );
}
